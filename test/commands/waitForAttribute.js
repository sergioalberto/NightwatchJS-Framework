...
const WaitForAttribute = (function (_events$EventEmitter) {
  _inherits(WaitForAttribute, _events$EventEmitter);

  function WaitForAttribute() {
    _classCallCheck(this, WaitForAttribute);

    const _this = _possibleConstructorReturn(this, (WaitForAttribute.__proto__ || Object.getPrototypeOf(WaitForAttribute)).call(this));
    ...
    value: function check(elementSelector, attribute, checker, callback, maxTimeInMilliseconds) {
      ...
      return this.api.getAttribute(elementSelector, attribute, (result) => {
        ...
        if (result.status === 0 && checker(result.value)) {
          ...
          return setTimeout(() => _this3.check(elementSelector, attribute, checker, callback, maxTimeInMilliseconds), _this3.timeoutRetryInMilliseconds);
        }
