...
const WaitForTitle = (function (_events$EventEmitter) {
  _inherits(WaitForTitle, _events$EventEmitter);

  function WaitForTitle() {
    _classCallCheck(this, WaitForTitle);

    const _this = _possibleConstructorReturn(this, (WaitForTitle.__proto__ || Object.getPrototypeOf(WaitForTitle)).call(this));
    ...
    value: function check(checker, callback, maxTimeInMilliseconds) {
      ...
      return this.api.getTitle((title) => {
        ...
        if (checker(title)) {
          ...
          return setTimeout(() => _this3.check(checker, callback, maxTimeInMilliseconds), _this3.timeoutRetryInMilliseconds);
        }
