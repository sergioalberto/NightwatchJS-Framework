...
When(/^I navigate to the login page$/, () => client.url(client.launch_url).pause(3500));

When(/^I validate that login page is displayed$/, () => {
  const text = 'Vacations Management Site - Growth Acceleration Partners';
  return client
    .title(({ value }) => {
...
Then(/^I click Sign in button$/, () => loginPage.click('@signInInput'));
